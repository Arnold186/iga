...
import { BookOpen, ClipboardList, LayoutDashboard, LogOut, MessageSquare, User, Users } from "lucide-react";
      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto flex max-w-[1400px] items-center justify-between px-4 py-3 md:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => navigate("/teacher/profile")}>
